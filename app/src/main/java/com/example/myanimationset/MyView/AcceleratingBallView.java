 ...
 * desc:
 */
public class AcceleratingBallView extends View {
    ...
    public AcceleratingBallView(Context context) {
        this(context, null);
    }

    public AcceleratingBallView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AcceleratingBallView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mPaintWavw = new Paint(Paint.ANTI_ALIAS_FLAG);//抗锯齿
        mPaintWavw.setColor(Color.parseColor("#33F92B"));
        mPaintWavw.setStyle(Paint.Style.FILL);//绘制图形的内容
        ...
        mPaintProgress.setTextAlign(Paint.Align.CENTER);//居中显示
